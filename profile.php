...
$jobs_messaged = R::find('messaged', 'cat = ? AND user_id = ?', ['job', $_SESSION["user"]["id"]]);
...
$folios_messaged = R::find('messaged', 'cat = ? AND user_id = ?', ['folio', $_SESSION["user"]["id"]]);
...
<div class="stat-wrap">
	...
	<a class="stat" href="/?filter=messaged&">APPLIED: <span><? echo count($jobs_messaged); ?></span></a>
	<br>
	<br>
	...
	<a class="stat" href="/portfolios.php?filter=messaged&">APPLIED: <span><? echo count($folios_messaged); ?></span></a>
</div>
